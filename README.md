...
Reveals selected players's roles: Only the roles of the players selected from the list are revealed

Clear selection: Clears all selections in the player list
